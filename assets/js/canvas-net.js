!function ()
{
    ...
    var i = t(function (e, t)
    {
        ...
        t.SizeSensorId = "size-sensor-id", t.SensorStyle = "display:block;position:absolute;top:0;left:0;height:100%;width:100%;overflow:hidden;pointer-events:none;z-index:-1;opacity:0", 
    ...
    var r = t(function (e, t)
    {
        ...
        t.createSensor = function (e)
        {
            ...
            }), a = function ()
            {
                ...
                t.parentNode.removeChild(t), t = void 0, n = []);
            };
            return {
                element : e,
                bind : function (r)
                {
                    t || (t = function ()
                    {
                        ...
                        t.setAttribute("style", i.SensorStyle), t.setAttribute("class", i.SensorClassName), 
    ...
    var y = function ()
    {
        function e(t, n)
        {
            ...
            (this, e), this.randomPoints = function ()
            {
                ...
                {
                    return {
                        x : Math.random() * o.canvas.width, y : Math.random() * o.canvas.height, xa : 2 * Math.random() - 1, 
                        ya : 2 * Math.random() - 1, max : 6e3
                    }
                })
            },
            this.el = t, this.c = h({
        ...
        return p(e, [
        {
            ...
            value : function ()
            {
                ...
                }), this.onmousemove = window.onmousemove, window.onmousemove = function (t)
                {
                    ...
                    e.current.y = t.clientY - e.el.offsetTop + document.scrollingElement.scrollTop, e.onmousemove && e.onmousemove(t);
                },
...

        {
            ...
            value : function ()
            {
                ...
                t.width = this.el.clientWidth, t.height = this.el.clientHeight, this.el.appendChild(t), 
                t;
            }
        },
...

        {
            ...
            value : function ()
            {
                ...
                {
                    for (r.x += r.xa, r.y += r.ya, r.xa *= r.x > n || r.x < 0 ?- 1 : 1, r.ya *= r.y > o || r.y < 0 ?- 1 : 1, 
                    t.fillStyle = "rgba(" + e.c.pointColor + ")", t.fillRect(r.x - .5, r.y - .5, 1, 1), 
                    u = f + 1;
                    u < a.length;
                    u++) null !== (s = a[u]).x && null !== s.y && (l = r.x - s.x, d = r.y - s.y, (v = l * l + d * d) < s.max && (s === i && v >= s.max / 2 && (r.x -= .03 * l, 
                    r.y -= .03 * d), c = (s.max - v) / s.max, t.beginPath(), t.lineWidth = c / 2, t.strokeStyle = "rgba(" + e.c.color + "," + (c + .2) + ")", 
    ...
    {
        zIndex : (b = w[w.length - 1]).getAttribute("zIndex"), opacity : b.getAttribute("opacity"), color : b.getAttribute("color"), 
        pointColor : b.getAttribute("pointColor"), count : Number(b.getAttribute("count")) || 99;
    }))
}();
